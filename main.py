...
def main():
    ...
    result = agent.invoke({"messages": [HumanMessage(content="search for 1 job posting for an ai engineer using langchain in the bay area on linkedin and list their details")]})
    print(result)
